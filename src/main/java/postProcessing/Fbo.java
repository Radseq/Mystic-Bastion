...
public class Fbo {
	...
	public Fbo(int width, int height) {
		this.width = width;
		this.height = height;
		//multisample off because i have black screen
	...
	public void resolveToFbo(int readBuffer, Fbo outputFbo) {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, outputFbo.width, outputFbo.height, GL11.GL_COLOR_BUFFER_BIT | GL11.GL_DEPTH_BUFFER_BIT, GL11.GL_NICEST);
		this.unbindFrameBuffer();
	}
	
	public void resolveToScreen() {
		GL30.glBindFramebuffer(GL30.GL_DRAW_FRAMEBUFFER, 0); //0 means default
		GL30.glBindFramebuffer(GL30.GL_READ_FRAMEBUFFER, this.frameBuffer);
		GL11.glDrawBuffer(GL11.GL_BACK);
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, Settings.WINDOW_WIDTH, Settings.WINDOW_HEIGHT, GL11.GL_COLOR_BUFFER_BIT, GL11.GL_NICEST);
		this.unbindFrameBuffer();
	}
